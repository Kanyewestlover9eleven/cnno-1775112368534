...
const basePath = '/cnno-1775112368534';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Craving some classics?', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For the nut lovers!', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Can\'t go wrong with chocolate!', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Small bites for snack time!', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'The best deal for parties!', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal cinnamon rolls that bring people together, fostering a sense of community and comfort through exceptional quality, creativity, and customer experience.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
